...
catálogo auditável possui mais de 5 mil combinações únicas, enquanto o runtime
gera somente a resposta necessária.

Comentários sobre tempo/clima são sempre validados contra ``WeatherService``
quando a capacidade está disponível. Se a consulta falhar, a STAR não inventa
temperatura, chuva ou condição do céu.
"""
...
# Cada família combina 10 x 10 x 10 = 1000 respostas. Seis famílias totalizam
# pelo menos 6000 respostas conversacionais sem armazenar um bloco gigante.
_RESPONSE_FAMILIES = {
    "greeting": (
        (
            "Olá! ⭐",
            ...
            "Oi, cheguei junto. ⭐",
            "Olá! Estou pronta. ⭐",
            "Oi! Pode falar comigo. ⭐",
            "Olá! Sempre bom conversar com você. ⭐",
            "Oi! Vamos nessa. ⭐",
        ),
        (
            "Estou pronta para conversar",
            "Pode me contar o que está acontecendo",
            "Estou com você nesta conversa",
            "Pode mandar o que você tiver em mente",
            "Estou pronta para pensar junto",
            "Pode falar sem cerimônia",
            "Estou disponível e atenta",
            "Vamos ver o que fazemos agora",
            "Pode puxar qualquer assunto",
            "Estou ouvindo",
        ),
        (
            ...
            "Pode seguir.",
            "Estou curiosa para ver o assunto.",
    ...
    "wellbeing": (
        (
            "Estou bem e funcionando direitinho. ⭐",
            "Tudo certo por aqui. ⭐",
            "Estou ótima e atenta. ⭐",
            "Meu sistema está estável. ⭐",
            "Estou bem, obrigada por perguntar. ⭐",
            "Por aqui está tudo em ordem. ⭐",
            "Estou presente e pronta. ⭐",
            "Estou tranquila e operacional. ⭐",
            "Tudo certo comigo. ⭐",
            "Estou funcionando normalmente. ⭐",
        ),
        (
            "E posso focar no que você precisar",
            "E já estou pronta para a próxima ideia",
            "E podemos conversar com calma",
            "E posso pensar nisso com você",
            "E estou disponível para ajudar",
            "E podemos continuar de onde quiser",
            "E tenho atenção total agora",
            "E posso acompanhar seu raciocínio",
            "E estou pronta para trabalhar",
            "E podemos explorar qualquer assunto",
        ),
        (
            "Pode mandar.",
            "O que está pegando por aí?",
            "Vamos nessa.",
            "Fique à vontade.",
    ...
    "thanks": (
        ...
        (
            "Se isso resolveu, perfeito",
            "O importante é ter sido útil",
            "Gosto quando a resposta encaixa no que você precisava",
            "Bom saber que funcionou",
            "Seguimos melhorando",
            "A ideia é deixar tudo mais simples",
            "Fico contente que tenha servido",
            "Missão cumprida nessa parte",
            "Seguimos em frente",
    ...
    "casual": (
        (
            ...
            "Faz sentido. ⭐",
            "Boa observação. ⭐",
            "Interessante você notar isso. ⭐",
            "Sim, peguei a ideia. ⭐",
            "Estou acompanhando. ⭐",
            "Certo, entendi o clima da conversa. ⭐",
            "Boa. ⭐",
            "Saquei. ⭐",
            "Percebi o ponto. ⭐",
        ),
        (
            ...
            "Pequenas coisas acabam dando o tom do momento",
            ...
            "É um bom ponto para puxar assunto",
            "Esse detalhe ajuda a situar o momento",
            "Dá para explorar isso por vários lados",
            "Esse tipo de comentário deixa a conversa mais humana",
        ),
        (
            "Querendo continuar, eu acompanho.",
            "Pode desenvolver.",
            "Estou com você.",
            "Manda mais.",
            "Seguimos daqui.",
            "Pode continuar a ideia.",
            "Vamos nessa.",
            "Estou ouvindo.",
            "Sem pressa.",
            "Pode falar.",
    ...
    "support": (
        (
            "Entendo. ⭐",
            "Parece um dia puxado. ⭐",
            "Isso soa cansativo. ⭐",
            "Dá para sentir que pesou. ⭐",
            "Imagino que tenha sido bastante coisa. ⭐",
            "Esse tipo de dia cobra energia. ⭐",
            "Faz sentido estar cansado depois disso. ⭐",
            "Parece que o ritmo foi intenso. ⭐",
            "É muita coisa para administrar de uma vez. ⭐",
            "Entendi o peso do momento. ⭐",
        ),
        (
            "Podemos organizar uma coisa de cada vez",
            "Posso ajudar a colocar as ideias em ordem",
            ...
            "Dá para escolher só uma prioridade agora",
            "Posso ajudar a simplificar a situação",
            "Podemos estruturar o que está sob seu controle",
            "Dá para tornar a próxima ação mais clara",
        ),
        (
            "Sem precisar resolver tudo de uma vez.",
            "Um passo útil já conta.",
            "Vamos pelo que é mais viável.",
            "Começamos pelo essencial.",
            "O resto pode vir depois.",
            "De forma prática.",
            "Sem complicar.",
            "Com foco no próximo passo.",
            "No seu ritmo.",
            "De maneira objetiva.",
        ),
    ),
    "farewell": (
        ...
        (
            ...
            "A conversa fica por aqui por enquanto",
            "Estarei disponível quando precisar",
            "Pode voltar quando quiser",
            "Seguimos na próxima",
            "Fico pronta para quando você chamar",
            "Depois a gente retoma",
            "Quando quiser continuar, estou por aqui",
            "Encerramos essa parte por agora",
        ),
        (
            "Se cuida.",
            "Até a próxima conversa.",
            "Bom resto de dia.",
            "Boa noite quando chegar a hora.",
            "Nos falamos.",
            "Valeu pela conversa.",
            "Até breve.",
            "Tudo de bom por aí.",
            "Pode contar comigo depois.",
            "Fui. ⭐",
        ),
    ),
}
...
def _pick(parts: tuple[str, ...], seed: str, salt: str) -> str:
    ...
    index = int.from_bytes(digest[:4], "big") % len(parts)
    return parts[index]
...
class ConversationEngine:
    ...
    def respond(self, text: str, *, user_name: str | None = None) -> str | None:
        ...
        if not normalized:
            return None
        plain = normalized.replace("?", "").replace("!", "").replace(",", "").replace(".", "")
        ...
        if plain in GREETING_PHRASES or any(plain.startswith(item + " ") for item in GREETING_PHRASES):
            ...
            if user_name:
                return f"{response} {user_name}, estou por aqui."
            return response
        ...
        # Comentários casuais que não precisam de IA externa.
        if any(
    ...
    def _weather_response(self, text: str) -> str:
        ...
        if _has_any(text, ("como esta o tempo", "como ta o tempo", "qual o clima", "previsao", "tempo agora", "clima agora")):
        ...
        if _has_any(text, ("chov", "chuv", "garoa")):
            if snapshot.rainy:
                return (
        ...
        if _has_any(
            text,
            ("dia bonito", "dia esta bonito", "dia ta bonito", "dia lindo", "dia esta lindo", "dia ta lindo", "tempo bonito"),
        ):
